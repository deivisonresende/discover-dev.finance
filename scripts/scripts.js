...
const DOM = {
  ...
  balanceContainer: document.getElementById('balance'),
  ...
  updateBalance() {
    ...
    let CSSclass = total < 0 ? 'expense' : 'income';

    var div = document.querySelector('#balance > div:nth-child(4)');
    let divClass = div.classList.value;

    if (divClass === 'card total') {
